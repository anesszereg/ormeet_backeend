                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2 text-sm text-[#4F4F4F]">
                      ...
                      <bdi>{eventDate.toLocaleDateString(localeMap[i18n.language] || 'en-US', { month: 'short', day: 'numeric' })}</bdi>
                    </div>
                    <span className="text-lg font-bold text-[#FF4000]"><bdi>{priceDisplay}</bdi></span>
                  </div>
