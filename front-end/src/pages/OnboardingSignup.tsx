...
const OnboardingSignup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store token and user data, then redirect to onboarding
      if (response.token) {
      ...
      <div className="flex-1 flex items-start justify-center p-4 sm:p-6 md:p-8 bg-white overflow-y-auto">
        <div className="w-full max-w-[460px] flex flex-col gap-4 sm:gap-6 py-6 sm:py-8 md:py-4">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="text-2xl sm:text-[28px] font-bold text-black">{t('onboardingSignup.title')}</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            >
              ...
              {t('onboardingSignup.signUpWithEmail')}
            </button>
            <button
            ...
            >
              ...
              {t('onboardingSignup.signUpWithPhone')}
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor={signupMethod === 'email' ? 'email' : 'phone'} className="text-sm font-medium text-black">
                {signupMethod === 'email' ? t('onboardingSignup.fields.emailLabel') : t('onboardingSignup.fields.phoneLabel')}
              </label>
              {signupMethod === 'email' ? (
                <input
                  id="email"
                  ...
                  placeholder={t('onboardingSignup.fields.emailPlaceholder')}
                ...
                <input
                  ...
                  placeholder={t('onboardingSignup.fields.phonePlaceholder')}
                  className="w-full px-4 py-3 border-[1.5px] border-[#EEEEEE] rounded-lg text-sm text-black placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#FF4000] focus:ring-1 focus:ring-[#FF4000] transition-all"
                  required
                />
              )}
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="password" className="text-sm font-medium text-black">
                {t('onboardingSignup.fields.passwordLabel')}
              </label>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pe-12 border-[1.5px] border-[#EEEEEE] rounded-lg text-sm text-black placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#FF4000] focus:ring-1 focus:ring-[#FF4000] transition-all"
                  required
                />
                <button
                  type="button"
              ...
              <p className="text-xs text-[#9CA3AF] mt-1">
                {t('onboardingSignup.fields.passwordHint')}
              </p>
            </div>
            ...
            <div className="flex items-center text-[#4F4F4F] text-sm">
              ...
              <span className="px-4">{t('onboardingSignup.orContinueWith')}</span>
              <div className="flex-1 h-px bg-[#EEEEEE]"></div> 
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              >
                ...
                {t('onboardingSignup.oauth.google')}
              </button>
              <button 
                type="button" 
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border-[1.5px] border-[#EEEEEE] rounded-lg bg-white text-sm font-medium text-[#4F4F4F] transition-all hover:border-[#434343] hover:bg-[#F8F8F8]" 
              ...
              >
                ...
                {t('onboardingSignup.oauth.facebook')}
              </button>
            </div>
            ...
            >
              {isLoading ? t('onboardingSignup.submitting') : t('onboardingSignup.submitButton')}
