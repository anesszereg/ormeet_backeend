...
async function seed() {
  ...
  try {
    ...
    const upcomingEvents = [
      ...
      // ───────────────────────────── Algeria ─────────────────────────────
      {
        title: 'Algiers Jazz Festival 2026',
        shortDescription: 'A week of international jazz on the Mediterranean coast',
        longDescription:
          'The Algiers Jazz Festival returns to the historic Casbah with 30+ artists from across Africa, Europe and the Middle East. Open-air stages, jam sessions and masterclasses by world-class musicians.',
        category: 'Music',
        status: EventStatus.PUBLISHED,
        locationType: LocationType.PHYSICAL,
        customLocation: {
          address: 'Place des Martyrs, Casbah',
          city: 'Algiers',
          state: 'Alger',
          zipCode: '16000',
          postalCode: '16000',
        ...
        startAt: new Date('2026-06-12T18:00:00'),
        endAt: new Date('2026-06-19T23:00:00'),
        capacity: 8000,
        images: ['https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f'],
        tickets: [
          { title: 'Festival Pass', price: 60, quantity: 5000, type: TicketTypeEnum.GENERAL_ADMISSION },
          { title: 'VIP Pass', price: 180, quantity: 1500, type: TicketTypeEnum.VIP },
          { title: 'Single Night', price: 15, quantity: 1500, type: TicketTypeEnum.GENERAL_ADMISSION },
        ],
      },
      {
        title: 'Oran Tech Summit',
        shortDescription: 'North-African tech & startup summit',
        longDescription:
          'Two days of talks, workshops and pitch competitions bringing together founders, investors and engineers from across the Maghreb and Europe. Tracks on AI, fintech, e-commerce and developer tooling.',
        category: 'Tech',
        status: EventStatus.PUBLISHED,
        locationType: LocationType.PHYSICAL,
        customLocation: {
          address: 'Le Méridien Oran Hotel & Convention Centre',
          city: 'Oran',
          state: 'Oran',
          zipCode: '31000',
          postalCode: '31000',
        ...
        startAt: new Date('2026-10-08T09:00:00'),
        endAt: new Date('2026-10-09T19:00:00'),
        capacity: 1200,
        images: ['https://images.unsplash.com/photo-1540575467063-178a50c2df87'],
        tickets: [
          { title: 'Standard', price: 90, quantity: 800, type: TicketTypeEnum.GENERAL_ADMISSION },
          { title: 'Founder Pass', price: 220, quantity: 250, type: TicketTypeEnum.VIP },
          { title: 'Student', price: 30, quantity: 150, type: TicketTypeEnum.STUDENT },
        ],
      },
      {
        title: 'Sahara Desert Marathon',
        shortDescription: '42 km run across the dunes of Tassili n\u2019Ajjer',
        longDescription:
          'An unforgettable endurance race through the red dunes of the Algerian Sahara. Includes pre-race camp at Djanet, guided cultural tours with Tuareg hosts and full medical / logistics support.',
        category: 'Sports',
        status: EventStatus.PUBLISHED,
        locationType: LocationType.PHYSICAL,
        customLocation: {
          address: 'Tassili n\u2019Ajjer National Park',
          city: 'Djanet',
          state: 'Illizi',
          zipCode: '33000',
          postalCode: '33000',
        ...
        startAt: new Date('2026-11-14T06:00:00'),
        endAt: new Date('2026-11-17T18:00:00'),
        capacity: 500,
        images: ['https://images.unsplash.com/photo-1509316785289-025f5b846b35'],
        tickets: [
          { title: 'Runner Entry', price: 950, quantity: 350, type: TicketTypeEnum.GENERAL_ADMISSION },
          { title: 'Runner + Premium Camp', price: 1600, quantity: 100, type: TicketTypeEnum.VIP },
          { title: 'Supporter / Volunteer', price: 250, quantity: 50, type: TicketTypeEnum.GENERAL_ADMISSION },
        ],
      },
      {
        title: 'Constantine Food & Couscous Festival',
        shortDescription: 'A celebration of Algerian gastronomy in the city of bridges',
        longDescription:
          'Three days of street food, traditional couscous competitions, pastry workshops and live music in the heart of Constantine. Over 80 local producers and chefs participating.',
        category: 'Food & Drink',
        status: EventStatus.PUBLISHED,
        locationType: LocationType.PHYSICAL,
        customLocation: {
        ...
        startAt: new Date('2026-08-21T11:00:00'),
        endAt: new Date('2026-08-23T23:00:00'),
        capacity: 6000,
        images: ['https://images.unsplash.com/photo-1504674900247-0877df9cc836'],
        tickets: [
          { title: 'Day Pass', price: 12, quantity: 4000, type: TicketTypeEnum.GENERAL_ADMISSION },
          { title: 'Tasting Pass (10 vendors)', price: 35, quantity: 1500, type: TicketTypeEnum.VIP },
          { title: 'Family Pack (4)', price: 40, quantity: 500, type: TicketTypeEnum.GROUP },
        ],
      },
      {
        title: 'Algiers Art Biennale',
        shortDescription: 'Contemporary art from across Africa and the Mediterranean',
        longDescription:
          'A month-long biennale featuring 60+ visual artists, installations across MAMA museum and the Bastion 23 cultural complex, plus talks, film screenings and guided tours.',
        category: 'Arts & Culture',
        status: EventStatus.PUBLISHED,
        locationType: LocationType.PHYSICAL,
        customLocation: {
          address: 'Musée d\u2019Art Moderne d\u2019Alger (MAMA)',
          city: 'Algiers',
          state: 'Alger',
          zipCode: '16000',
          postalCode: '16000',
        ...
        startAt: new Date('2026-05-02T10:00:00'),
        endAt: new Date('2026-06-02T20:00:00'),
        capacity: 20000,
        images: ['https://images.unsplash.com/photo-1531058020387-3be344556be6'],
        tickets: [
          { title: 'General Admission', price: 8, quantity: 15000, type: TicketTypeEnum.GENERAL_ADMISSION },
          { title: 'Guided Tour', price: 20, quantity: 3000, type: TicketTypeEnum.VIP },
          { title: 'Student/Senior', price: 4, quantity: 2000, type: TicketTypeEnum.STUDENT },
        ],
      },
    ];
